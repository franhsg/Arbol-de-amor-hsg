...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Te elijo en el silencio y en la risa, en el ayer que nos trajo hasta aquí y en cada mañana que aún no nace. Eres hilo que le da sentido a todo mi mapa`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Fran";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2016-03-28T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-03-28T00:00:00');
